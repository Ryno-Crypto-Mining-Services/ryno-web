...
import crmDashboardBl from '../assets/crm-dashboard-bl.webp';
import crmDashboardTr from '../assets/crm-dashboard-tr.webp';
import crmDashboardR from '../assets/crm-dashboard-r.webp';
